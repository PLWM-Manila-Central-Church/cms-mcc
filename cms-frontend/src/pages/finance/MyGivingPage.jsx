...
const s = {
  ...
  totalCard:      { background: 'linear-gradient(135deg, #1e3a5f, #2563eb)', color: '#fff', borderRadius: '16px', padding: '28px 32px', marginBottom: '20px', textAlign: 'center' },
  ...
  categoryTag:    { background: '#eff6ff', color: '#2563eb', padding: '3px 10px', borderRadius: '20px', fontSize: '12px', fontWeight: '600' },
