...
exports.createUser = async (data, createdBy) => {
  const { email, password, role_id, member_id, invited_member_id, leads_ministry_id } = data;
...
exports.updateUser = async (id, data, updatedBy) => {
  ...
  const { email, role_id, member_id, invited_member_id, is_active, leads_ministry_id } = data;
