...
// System Admin / Pastor / Reg Team (no ministryRoleId) see all.
exports.getInvitesByEvent = async (req, res, next) => {
  try {
    const ministryRoleId = req.user.ministryRoleId || null;
...
// ── Create Invites (bulk) ────────────────────────────────────
// Only a Ministry Leader may create invites (must have ministryRoleId).
