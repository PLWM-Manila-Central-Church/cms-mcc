...
router.get("/substitutes/pending",   auth, authorize("ministry", "read"),   ctrl.getPendingSubstitutes);
router.put("/substitutes/:id/resolve", auth, authorize("ministry", "update"), ctrl.resolveSubstitute);
