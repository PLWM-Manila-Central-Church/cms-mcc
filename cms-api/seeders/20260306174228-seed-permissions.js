...
module.exports = {
  up: async (queryInterface) => {
    ...
    const permsToAdd = [
      ...
      // ── Cell Groups ────────────────────────────────────────
      { module: "cellgroups", action: "read", description: "View cell groups", created_at: now, updated_at: now },
      { module: "cellgroups", action: "create", description: "Create cell groups", created_at: now, updated_at: now },
      { module: "cellgroups", action: "update", description: "Edit cell groups", created_at: now, updated_at: now },
      { module: "cellgroups", action: "delete", description: "Delete cell groups", created_at: now, updated_at: now },
      // ── Notifications ──────────────────────────────────────
  ...
  down: async (queryInterface) => {
    await queryInterface.bulkDelete("permissions", null, {});
      ...
      // ── Archives ───────────────────────────────────────────
      {
        module: "archives",
        action: "read",
        description: "View archive documents",
        created_at: now,
        updated_at: now,
      },
      {
        module: "archives",
        action: "create",
        description: "Upload archive documents",
        created_at: now,
        updated_at: now,
      },
      {
        module: "archives",
        action: "update",
        description: "Edit/approve archive docs",
        created_at: now,
        updated_at: now,
      },
      {
        module: "archives",
        action: "delete",
        description: "Delete archive documents",
        created_at: now,
        updated_at: now,
      },
      ...
      },
      {
        module: "ministry",
        action: "create",
        description: "Create ministry assignments",
        created_at: now,
        updated_at: now,
      },
      {
        module: "ministry",
        action: "update",
        description: "Edit ministry assignments",
        created_at: now,
        updated_at: now,
      },
      {
      ...
      },
      {
        module: "cellgroups",
        action: "delete",
        description: "Delete cell groups",
        created_at: now,
        updated_at: now,
      },
